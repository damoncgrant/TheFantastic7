...
urlpatterns = [
    ...
    path("messages/unread/", notification_views.unread_messages, name="unread-messages"),
    ...
    path("applications/<int:application_id>/action/", views.recruiter_application_action, name="recruiter-application-action"),
    ...
    path("applications/<int:application_id>/messages/read/", views.mark_messages_read, name="mark-messages-read"),
